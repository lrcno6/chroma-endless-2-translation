onEvent("ponder.registry", event => {
    event.create([
        ...
        .scene('bir_1', 'Building a Bigger Reactor', 'kubejs:reactor', (scene, util) => {
            ...
            scene.overlay.showText(40).text("The edges must be reactor casing").independent(20);
            [1, 2, 3, 4].forEach(num => {
            ...
            scene.overlay.showText(35).text("The walls can be reactor casing or reactor glass").independent(20);
            //top glass
            ...
            scene.overlay.showText(40).text("Fuel rods run floor to ceiling in a stack").independent(20);
            scene.idle(10)
            ...
            scene.idle(10)
            scene.overlay.showText(35).text("A control rod sits atop the fuel rod stack in the top wall").independent(20);
            scene.idle(15)
            ...
            scene.overlay.showText(35).text("A terminal needs to be included in a wall").independent(20);
            scene.idle(10)
            ...
            scene.overlay.showText(35).text("A power tap is used in a wall to get power out of the reactor").independent(20);
            scene.idle(15)
            ...
            scene.overlay.showText(40).text("Access ports allow for insertion of uranium and removal of cyanite").independent(20);
            scene.idle(15)
